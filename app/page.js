...
const DISCORD_INVITE_URL = 'https://discord.gg/FEjMjNGRFg';
...
const MODULAR_SLOTS = [
    ...
    },
    {
        ...
        mechanic:
            'Dictates Action Bar fill speed (Clock Speed), evasion (Packet Loss), and terrain compatibility across Bipedal, Wheeled, Tracks, Hover, Aquatic, and Multi-Leg.',
        ...
        <div className='flex flex-col min-h-screen bg-[#070b12] text-slate-100 cyber-grid relative'>
            ...
            <header className='sticky top-0 z-50 backdrop-blur-md bg-[#070b12]/85 border-b border-cyan-500/20'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between'>
                    ...
                    <nav className='hidden md:flex items-center gap-7 text-sm font-medium text-slate-300'>
                        ...
                        <a href='#modular-system' className='hover:text-cyan-400 transition-colors'>
                            Modular Systems
                        </a>
                        <a href='#contributors' className='text-cyan-400 hover:text-cyan-300 transition-colors font-semibold'>
                            Contributors Wanted
                        </a>
                        <a href='#onboarding' className='hover:text-cyan-400 transition-colors'>
                            How to Join
                        </a>
            ...
            <section id='overview' className='relative pt-16 pb-20 md:pt-24 md:pb-28 border-b border-slate-800/80 overflow-hidden'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center'>
                    ...
                    <h1 className='text-4xl sm:text-6xl lg:text-7xl font-black tracking-tight text-white max-w-5xl mx-auto uppercase font-mono'>
                        ...
                        <br />
                        Command Autonomous{' '}
                        <span className='text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-rose-300 to-cyan-400'>AI Souls</span>.
                    </h1>
                    ...
                    <p className='mt-6 text-lg sm:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed font-sans'>
                        ...
                        (<span className='text-amber-400 font-semibold'>Anima Chips</span>), 5-slot modular chassis engineering, and a persistent hardware
                        degradation scrap economy.
                    </p>
            ...
            <section id='contributors' className='py-20 md:py-28 bg-[#090e18] border-b border-slate-800 relative'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center max-w-3xl mx-auto mb-14'>
                        ...
                        <h2 className='text-3xl sm:text-5xl font-extrabold text-white font-mono tracking-tight'>Calling Artists, Animators & Developers</h2>
                        <p className='mt-4 text-slate-300 text-base sm:text-lg'>
                            AniBots is an ambitious community indie project built in the open. Whether you draw pixel art, model 3D mechas, write GDScript
                            systems, or compose chiptunes, there is a dedicated place for your craft.
                        </p>
                    </div>
                    ...
                    <div className='bg-slate-900/90 border border-cyan-500/30 rounded-xl p-6 sm:p-10 shadow-2xl relative overflow-hidden backdrop-blur-md'>
                        ...
                        <div className='flex flex-col lg:flex-row gap-8 items-start justify-between relative z-10'>
                            <div className='flex-1'>
                                ...
                                <h4 className='text-xs font-mono uppercase tracking-widest text-slate-400 mb-3'>What We Need from You:</h4>
                            ...
                            <div className='w-full lg:w-80 bg-slate-950/90 border border-slate-800 rounded-lg p-5 flex flex-col justify-between'>
                                <div>
                                    ...
                                    <p className='text-xs text-slate-400 mb-4 leading-relaxed'>
                                        Check current active tasks on our GitHub issue board or join our Discord channel to coordinate directly with developers
                                        and lead artists.
                                    </p>
                                </div>
            ...
            <section id='modular-system' className='py-20 md:py-28 bg-[#070b12] border-b border-slate-800'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center max-w-3xl mx-auto mb-16'>
                        ...
                        <h2 className='text-3xl sm:text-5xl font-extrabold text-white font-mono tracking-tight'>5-Slot Modular Hardware Anatomy</h2>
                        <p className='mt-4 text-slate-300 text-base sm:text-lg'>
                            Every AniBot is assembled from 5 swappable components. Handlers must balance loadout weight, cooling rates, and terrain locomotion
                            protocols.
                        </p>
                    </div>
                        ...
                        <div className='lg:col-span-7 bg-slate-900/90 border border-slate-700 rounded-xl p-6 sm:p-8 relative overflow-hidden'>
                            ...
                            <div className='space-y-4'>
                                <div>
                                    ...
                                    <p className='text-slate-200 text-sm sm:text-base leading-relaxed'>{MODULAR_SLOTS[activeSlot].mechanic}</p>
                                </div>

                                <div className='p-4 rounded-lg bg-slate-950 border border-slate-800'>
                                    <div className='text-xs font-mono uppercase text-cyan-400 mb-1'>Key Scaling Attributes</div>
                                    <div className='text-sm font-mono text-slate-300'>{MODULAR_SLOTS[activeSlot].statFocus}</div>
                                </div>
                    ...
                    <div className='mt-20'>
                        <div className='text-center mb-8'>
                            ...
                            <p className='text-sm text-slate-400 mt-1 max-w-2xl mx-auto'>
                                Each chip operates on a Weighted Utility AI scoring system to evaluate targets dynamically, equipped with distinct personality
                                engrams and battle haikus.
                            </p>
                        </div>
            ...
            <section id='onboarding' className='py-20 bg-[#090e18] border-b border-slate-800'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center max-w-2xl mx-auto mb-14'>
                        ...
                        <p className='mt-3 text-slate-400 text-sm'>We welcome first-time open source contributors as well as seasoned gamedev veterans.</p>
                    </div>
                    ...
                    <div className='grid md:grid-cols-4 gap-6'>
                        <div className='p-6 rounded-lg bg-slate-900/80 border border-slate-800 relative'>
                            ...
                            <p className='text-xs text-slate-300 leading-relaxed'>
                                Introduce yourself in <code className='text-cyan-400'>#contributions</code>, share your portfolio or past projects, and meet
                                team leads.
                            </p>
                        </div>
                        ...
                        <div className='p-6 rounded-lg bg-slate-900/80 border border-slate-800 relative'>
                            ...
                            <p className='text-xs text-slate-300 leading-relaxed'>
                                Read our modular design specs (<code className='text-cyan-400'>PARTS.md</code>, <code className='text-cyan-400'>GAME.md</code>,{' '}
                                <code className='text-cyan-400'>OVERVIEW.md</code>) in the repository.
                            </p>
                        </div>
                        ...
                        <div className='p-6 rounded-lg bg-slate-900/80 border border-slate-800 relative'>
                            ...
                            <p className='text-xs text-slate-300 leading-relaxed'>
                                Pick a ticket marked <code className='text-cyan-400'>good first issue</code> on GitHub or pitch your own robot chassis, sprite,
                                or feature in Discussions.
                            </p>
                        </div>
                    ...
                    <div className='mt-12 p-5 rounded-lg border border-slate-800 bg-slate-950/60 max-w-3xl mx-auto text-center'>
                        <div className='text-xs font-mono text-amber-400 uppercase tracking-wider font-semibold mb-1'>AI Tools & Creator Respect Policy</div>
                        <p className='text-xs text-slate-400 leading-relaxed'>
                            AI tool assistance is permitted to accelerate development. We deeply respect all human artists, animators, and developers: every
                            contributor will be honored and permanently credited in the project databank and credits roll.
                        </p>
                    </div>
                </div>
            </section>
            ...
            <section id='community' className='py-20 md:py-28 bg-[#070b12] border-b border-slate-800 relative'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
                    <div className='text-center max-w-3xl mx-auto mb-16'>
                        ...
                        <h2 className='text-3xl sm:text-5xl font-extrabold text-white font-mono tracking-tight'>Join Our Community & Hub</h2>
                        <p className='mt-4 text-slate-300 text-base sm:text-lg'>
                            Coordinate real-time with developers and artists on Discord, participate in feature design in GitHub Discussions, or report bugs and
                            submit code.
                        </p>
                    </div>
                    ...
                    <div className='grid lg:grid-cols-12 gap-8 items-start'>
                        ...
                        {/* Discord Community Card Column */}
                        <div className='lg:col-span-5 flex flex-col justify-between bg-gradient-to-b from-slate-900/95 via-purple-950/20 to-slate-900/95 border border-purple-500/30 rounded-xl p-6 sm:p-8 shadow-2xl relative overflow-hidden'>
                            ...
                            <div>
                                <div className='flex items-center justify-between mb-6'>
                                    <div className='flex items-center gap-2.5'>
                                        ...
                                        <div>
                                            <span className='font-mono text-sm font-bold text-white block'>AniBots Discord</span>
                                            <span className='text-[11px] font-mono text-purple-300'>Official Community Hub</span>
                                        </div>
                                    </div>
                                    <span className='inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full bg-green-500/10 border border-green-500/30 text-[11px] font-mono text-green-400'>
                                ...
                                <p className='text-slate-300 text-sm leading-relaxed mb-6'>
                                    Connect directly with game devs, pixel artists, and 3D animators. Share work-in-progress assets, pitch new robot chassis
                                    designs, and test pre-release builds.
                                </p>

                                <div className='space-y-3 mb-8'>
                                    <div className='flex items-center gap-3 p-3 rounded-lg bg-slate-950/70 border border-slate-800 text-xs'>
                                        <span className='font-mono font-bold text-cyan-400'>#contributions</span>
                                        <span className='text-slate-300'>Coordinate code, 2D sprites, and 3D models</span>
                                    </div>
                                    <div className='flex items-center gap-3 p-3 rounded-lg bg-slate-950/70 border border-slate-800 text-xs'>
                                        <span className='font-mono font-bold text-amber-400'>#playtesting</span>
                                        <span className='text-slate-300'>Test 3-Phase ATB combat and report balance notes</span>
                                    </div>
                                    <div className='flex items-center gap-3 p-3 rounded-lg bg-slate-950/70 border border-slate-800 text-xs'>
                                        <span className='font-mono font-bold text-purple-400'>#lore-and-audio</span>
                                        <span className='text-slate-300'>Develop Anima Chip personality engrams and OSTs</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                <a
                                    ...
                                    target='_blank'
                                    rel='noopener noreferrer'
                                    className='w-full inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-lg bg-[#5865F2] hover:bg-[#4752C4] text-white font-mono font-bold text-sm uppercase tracking-wider shadow-[0_0_20px_rgba(88,101,242,0.4)] transition-all group cursor-pointer'
                                >
                                    <svg className='w-5 h-5 fill-current' viewBox='0 0 24 24'>
                                        <path d='M20.317 4.37a19.791 19.791 0 0 0-4.885-1.515.074.074 0 0 0-.079.037c-.21.375-.444.864-.608 1.25a18.27 18.27 0 0 0-5.487 0 12.64 12.64 0 0 0-.617-1.25.077.077 0 0 0-.079-.037A19.736 19.736 0 0 0 3.677 4.37a.07.07 0 0 0-.032.027C.533 9.046-.32 13.58.099 18.057a.082.082 0 0 0 .031.057 19.9 19.9 0 0 0 5.993 3.03.078.078 0 0 0 .084-.028c.462-.63.874-1.295 1.226-1.994.021-.041.001-.09-.041-.106a13.107 13.107 0 0 1-1.872-.892.077.077 0 0 1-.008-.128 10.2 10.2 0 0 0 .372-.292.074.074 0 0 1 .077-.01c3.929 1.793 8.18 1.793 12.061 0a.074.074 0 0 1 .078.01c.12.098.246.198.373.292a.077.077 0 0 1-.006.127 12.299 12.299 0 0 1-1.873.894.077.077 0 0 0-.041.107c.36.698.772 1.362 1.225 1.993a.076.076 0 0 0 .084.028 19.839 19.839 0 0 0 6.002-3.03.077.077 0 0 0 .032-.054c.5-5.177-.838-9.674-3.549-13.66a.061.061 0 0 0-.031-.028zM8.02 15.33c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.956-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.956 2.418-2.157 2.418zm7.975 0c-1.183 0-2.157-1.085-2.157-2.419 0-1.333.955-2.419 2.157-2.419 1.21 0 2.176 1.096 2.157 2.42 0 1.333-.946 2.418-2.157 2.418z' />
                                    </svg>
                                ...
                                <div className='mt-3 text-center'>
                                    <span className='text-[11px] font-mono text-slate-400'>Permanent link: </span>
                                    <code className='text-[11px] font-mono text-purple-300 select-all'>discord.gg/FEjMjNGRFg</code>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <footer className='py-12 bg-[#05080e] border-t border-slate-800 text-slate-400 text-xs font-mono'>
                <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-6'>
                    ...
                    <div className='text-slate-500'>MIT Licensed • Built with Next.js & Tailwind CSS</div>
                </div>
            </footer>
        </div>
    );
